...

{
    ...
    "EssTweaksOO": {
        "InvokeScript": [
            ...
            Start-BitsTransfer -Source \"https://raw.githubusercontent.com/ChadYCyd/SlimLine-Windows-Booster/master/ooshutup10.cfg\" -Destination C:\\Windows\\Temp\\ooshutup10.cfg
