...
if($confirm -eq "yes"){
    ...
    if($IsAdmin -eq $false){
        ...
        Start-Process -Verb runas -FilePath powershell.exe -ArgumentList "iwr -useb https://tinyurl.com/SlimLineWindowsBooster2 | iex"
        break
    }

    $inputXML = (new-object Net.WebClient).DownloadString("https://raw.githubusercontent.com/ChadYCyd/SlimLine-Windows-Booster/master/MainWindow.xaml")
    $configs | ForEach-Object {
    }
}
    ...
    write-host ""                                                                                                                             
    write-host "    SSSSSSSSSSSSSSSSSS"     
    write-host "SSSSSSSSSSSSSSSSSSSSSSSS"
    write-host "SSSSSSSSSSSSSSSSSSSSSSSSSS"
    write-host "SSSSSSSSSSSSSSSSSSSSSSSS"
    write-host "SSSSSSS"
    write-host "SSSSSSS"
    write-host "SSSSSSSSSSSSSSSSSSSSSS"
    write-host "SSSSSSSSSSSSSSSSSSSSSSSS"
    write-host "SSSSSSSSSSSSSSSSSSSSSSSSS"
    write-host "                SSSSSSSSS"
    write-host "                SSSSSSSSS"
    write-host "                SSSSSSSS"
    write-host "SSSSSSSSSSSSSSSSSSSSSSS"
    write-host "SSSSSSSSSSSSSSSSSSSSSS"
    write-host "SSSSSSSSSSSSSSSSSSSS"
    write-host "sssssssssssssssssss"
    write-host ""
    write-host "====ChadYCyd Tech====="
    write-host "=====SlimLine Windows Booster====="
...
Example usage: 
    ...
    $env:args = "Install:git.git,WinDirStat.WinDirStat "; iwr -useb https://tinyurl.com/SlimLineWindowsBooster2 | iex

    $env:args = "Tweaks:EssTweaksLoc,EssTweaksServices"; iwr -useb https://tinyurl.com/SlimLineWindowsBooster2 | iex

    $env:args = "DefaultUpdates"; iwr -useb https://tinyurl.com/SlimLineWindowsBooster2 | iex

    $env:args = "Install:git.git,WinDirStat.WinDirStat Tweaks:EssTweaksLoc,EssTweaksServices DefaultUpdates"; iwr -useb https://tinyurl.com/SlimLineWindowsBooster2 | iex
...
Write-Host "Thank you for supporting Slimline Windows Booster!"
