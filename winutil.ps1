...
.NOTES
   Author      : ChadYCyd
   GitHub      : https://github.com/ChadYCyd
    Version 0.1
#>

$inputXML = (new-object Net.WebClient).DownloadString("https://raw.githubusercontent.com/ChadYCyd/SlimLine-Windows-Booster/master/MainWindow.xaml") #uncomment for Production
...
$WPFtweaksbutton.Add_Click({
        ...
        If ( $WPFEssTweaksOO.IsChecked -eq $true ) {
            If (!(Test-Path .\ooshutup10.cfg)) {
                ...
                curl.exe -ss "https://raw.githubusercontent.com/ChadYCyd/SlimLine-Windows-Booster/master/ooshutup10.cfg" -o ooshutup10.cfg
        ...
        If ( $WPFEssTweaksRemoveEdge.IsChecked -eq $true ) {
            ...
            Invoke-WebRequest -useb https://raw.githubusercontent.com/ChadYCyd/SlimLine-Windows-Booster/master/Remove_MS_Edge.bat | Invoke-Expression
            $WPFEssTweaksRemoveEdge.IsChecked = $false
        }
